...
define('DOMAIN_URL', 'https://sfis.graymatterworks.com/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
define('ALLOW_MODIFICATION', 1);
define('JWT_SECRET_KEY', '12345678'); /* chnage to your secret key here set it to anything you like*/
define('MAIN_REFER', 'SFIS');
...
class Database
{
    ...
    private $db_user = "u743445510_sfis";  // Change as required
    private $db_pass = "Sfis@2023";  // Change as required
    private $db_name = "u743445510_sfis";    // Change as required
